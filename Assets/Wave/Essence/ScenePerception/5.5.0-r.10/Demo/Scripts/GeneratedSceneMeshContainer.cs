...
namespace Wave.Essence.ScenePerception.Sample
{
	public class GeneratedSceneMeshContainer : IDisposable
	{
		...
		public void SetVisibility(bool isVisible)
		{
			...
			{
				if (generatedSceneMesh.go != null)
				{
					Renderer renderer = generatedSceneMesh.go.GetComponent<Renderer>();
					if (renderer != null)
					{
		...
		{
			//Log.d(LOG_TAG, "Add new scene mesh");
			GameObject newSceneMeshGO = scenePerceptionManager.GenerateSceneMesh(sceneMesh, generatedMeshMaterialWireframe, true);
